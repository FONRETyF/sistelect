<?php
    ...
    $nombreArchivo = "RESULTADOS ZINACANTEPEC JOVENES";
    ...
    $activeWorksheet->getColumnDimension('G')->setWidth(150,'pt');
    $activeWorksheet->getColumnDimension('H')->setWidth(100,'pt');
    $activeWorksheet->getColumnDimension('I')->setWidth(80,'pt');
    $activeWorksheet->getColumnDimension('J')->setWidth(90,'pt');
    ...
    $activeWorksheet->mergeCells('A2:K2')->getStyle('A2:K2')->getAlignment()->setHorizontal('center');

    $pdo = new db();
    $db=$pdo->conexion();
        
    $statement = $db->prepare("SELECT id, cveelector, apepat, apemat, nombre, fechnac, domicilio, telefono, seccelec, municipio, estatvoto, turnvoto FROM public.padronzinjov order by id asc");
    $statement->execute();
    $results = $statement->fetchAll(PDO::FETCH_ASSOC);  
            
    $activeWorksheet->setCellValue('A3',"");
    $activeWorksheet->mergeCells('A3:K3')->getStyle('A3:K3')->getAlignment()->setHorizontal('center');

    $activeWorksheet->getStyle('A5:K5')->getAlignment()->setHorizontal('center');
    ...
    $activeWorksheet->setCellValue('G5','DOMICILIO');
    $activeWorksheet->setCellValue('H5','TELEFONO');
    $activeWorksheet->setCellValue('I5','SECCION');
    $activeWorksheet->setCellValue('J5','MUNICIPIO');
    $activeWorksheet->setCellValue('K5','URNO DE VOTO');
    ...
    foreach ($results as $row) {
        ...
        $activeWorksheet->setCellValue('G'. $numregExcel,$row["domicilio"]);
        $activeWorksheet->setCellValue('G'. $numregExcel,$row["telefono"]);
        $activeWorksheet->setCellValue('I'. $numregExcel,$row["seccelec"]);
        $activeWorksheet->setCellValue('J'. $numregExcel,$row["municipio"]);
        $activeWorksheet->setCellValue('K'. $numregExcel,$row["turnvoto"]);
        ...
        $celfdas= "A".$numregExcel.":K".$numregExcel."";
    ...
    switch ($turno) {
        case 1:
            $nombreArchivo = "RESULTADOS ZINACANTEPEC JOVENES - TURNO 1";
            ...
            $hoja2->getColumnDimension('G')->setWidth(150,'pt');
            $hoja2->getColumnDimension('H')->setWidth(100,'pt');
            $hoja2->getColumnDimension('I')->setWidth(80,'pt');
            $hoja2->getColumnDimension('J')->setWidth(90,'pt');
            $hoja2->getColumnDimension('K')->setWidth(90,'pt');
            
            $hoja2->getStyle('A2')->getFont()->SetBold(true);
            $hoja2->getStyle('A2')->getFont()->SetSize(14);
            $hoja2->setCellValue('A2', "TURNO 1 - ZINACANTEPEC JOVENES");
            $hoja2->mergeCells('A2:K2')->getStyle('A2:K2')->getAlignment()->setHorizontal('center');

            $statementTurno = $db->prepare("SELECT id, cveelector, apepat, apemat, nombre, fechnac, domicilio, telefono, seccelec, municipio, estatvoto, turnvoto FROM public.padronzinjov WHERE turnvoto='".$turno."' order by id asc");
            $statementTurno->execute();
            $resultsTurno = $statementTurno->fetchAll(PDO::FETCH_ASSOC);

            $hoja2->setCellValue('A3',"");
            $hoja2->mergeCells('A3:K3')->getStyle('A3:K3')->getAlignment()->setHorizontal('center');

            $hoja2->getStyle('A5:K5')->getAlignment()->setHorizontal('center');
            ...
            $hoja2->setCellValue('G5','DOMICILIO');
            $hoja2->setCellValue('H5','TELEFONO');
            $hoja2->setCellValue('I5','SECCION');
            $hoja2->setCellValue('J5','MUNICIPIO');
            $hoja2->setCellValue('K5','TURNO DE VOTO');
            ...
            foreach ($resultsTurno as $row) {
                ...
                $hoja2->setCellValue('G'. $numregExcel,$row["domicilio"]);
                $hoja2->setCellValue('H'. $numregExcel,$row["telefono"]);
                $hoja2->setCellValue('I'. $numregExcel,$row["seccelec"]);
                $hoja2->setCellValue('J'. $numregExcel,$row["municipio"]);
                $hoja2->setCellValue('K'. $numregExcel,$row["turnvoto"]);
            ...
            $hoja3->setCellValue('A2', "ESTADISTICAS - ZINACANTEPEC JOVENES");
            ...
            $hoja3->setCellValue('A6','ZINACANTEPEC JOVENES');
        ...
        case 2:
            $nombreArchivo = "RESULTADOS ZINACANTEPEC JOVENES - TURNO 2";
            $statementTurno = $db->prepare("SELECT id, cveelector, apepat, apemat, nombre, fechnac, domicilio, telefono, seccelec, municipio, estatvoto, turnvoto FROM public.padronzinjov WHERE turnvoto='1' or turnvoto='".$turno."' order by turnvoto,id asc");
            $statementTurno->execute();
            $resultsTurno = $statementTurno->fetchAll(PDO::FETCH_ASSOC);
            ...
            $hoja3->getColumnDimension('G')->setWidth(150,'pt');
            $hoja3->getColumnDimension('H')->setWidth(100,'pt');
            $hoja3->getColumnDimension('I')->setWidth(80,'pt');
            $hoja3->getColumnDimension('J')->setWidth(90,'pt');
            $hoja3->getColumnDimension('K')->setWidth(90,'pt');
            
            $hoja3->getStyle('A2')->getFont()->SetBold(true);
            $hoja3->getStyle('A2')->getFont()->SetSize(14);
            $hoja3->setCellValue('A2', "TURNO 2 - ZINACANTEPEC JOVENES");
            $hoja3->mergeCells('A2:K2')->getStyle('A2:K2')->getAlignment()->setHorizontal('center');

            $hoja3->setCellValue('A3',"");
            $hoja3->mergeCells('A3:K3')->getStyle('A3:K3')->getAlignment()->setHorizontal('center');

            $hoja3->getStyle('A5:K5')->getAlignment()->setHorizontal('center');
            ...
            $hoja3->setCellValue('G5','DOMICILIO');
            $hoja3->setCellValue('H5','TELEFONO');
            $hoja3->setCellValue('I5','SECCION');
            $hoja3->setCellValue('J5','MUNICIPIO');
            $hoja3->setCellValue('K5','TURNO DE VOTO');
            ...
            foreach ($resultsTurno as $row) {
                if ($row["turnvoto"] == '1') {
                    ...
                    $hoja3->setCellValue('G'. $numregExcel2,$row["domicilio"]);
                    $hoja3->setCellValue('H'. $numregExcel2,$row["telefono"]);
                    $hoja3->setCellValue('I'. $numregExcel2,$row["seccelec"]);
                    $hoja3->setCellValue('J'. $numregExcel2,$row["municipio"]);
                    $hoja3->setCellValue('K'. $numregExcel2,$row["turnvoto"]);

                    $celfdas= "A".$numregExcel2.":K".$numregExcel2."";
            ...
            $hoja4->setCellValue('A2', "ESTADISTICAS - ZINACANTEPEC JOVENES");
            ...
            $hoja4->setCellValue('A6','ZINACANTEPEC JOVENES');
        ...
        case 3:
            $nombreArchivo = "RESULTADOS ZINACANTEPEC JOVENES - TURNO 3";
            $statementTurno = $db->prepare("SELECT id, cveelector, apepat, apemat, nombre, fechnac, domicilio, telefono, seccelec, municipio, estatvoto, turnvoto FROM public.padronzinjov WHERE turnvoto='1' or turnvoto='2' or turnvoto='".$turno."' order by turnvoto,id asc");
            $statementTurno->execute();
            $resultsTurno = $statementTurno->fetchAll(PDO::FETCH_ASSOC);
            ...
            $hoja4->getColumnDimension('G')->setWidth(150,'pt');
            $hoja4->getColumnDimension('H')->setWidth(100,'pt');
            $hoja4->getColumnDimension('I')->setWidth(80,'pt');
            $hoja4->getColumnDimension('J')->setWidth(90,'pt');
            $hoja4->getColumnDimension('K')->setWidth(90,'pt');
            
            $hoja4->getStyle('A2')->getFont()->SetBold(true);
            $hoja4->getStyle('A2')->getFont()->SetSize(14);
            $hoja4->setCellValue('A2', "TURNO 3 - ZINACANTEPEC JOVENES");
            $hoja4->mergeCells('A2:K2')->getStyle('A2:K2')->getAlignment()->setHorizontal('center');

            $hoja4->setCellValue('A3',"");
            $hoja4->mergeCells('A3:K3')->getStyle('A3:K3')->getAlignment()->setHorizontal('center');

            $hoja4->getStyle('A5:K5')->getAlignment()->setHorizontal('center');
            ...
            $hoja4->setCellValue('G5','DOMICILIO');
            $hoja4->setCellValue('H5','TELEFONO');
            $hoja4->setCellValue('I5','SECCION');
            $hoja4->setCellValue('J5','MUNICIPIO');
            $hoja4->setCellValue('K5','TURNO DE VOTO');
            ...
            foreach ($resultsTurno as $row) {
                if ($row["turnvoto"] == '1') {
                    ...
                    $hoja4->setCellValue('G'. $numregExcel3,$row["domicilio"]);
                    $hoja4->setCellValue('H'. $numregExcel3,$row["telefono"]);
                    $hoja4->setCellValue('I'. $numregExcel3,$row["seccelec"]);
                    $hoja4->setCellValue('J'. $numregExcel3,$row["municipio"]);
                    $hoja4->setCellValue('K'. $numregExcel3,$row["turnvoto"]);

                    $celfdas= "A".$numregExcel3.":K".$numregExcel3."";
            ...
            $hoja5->setCellValue('A2', "ESTADISTICAS - ZINACANTEPEC JOVENES");
            ...
            $hoja5->setCellValue('A6','ZINACANTEPEC JOVENES');
        ...
        case 4:
            $nombreArchivo = "RESULTADOS ZINACANTEPEC JOVENES - TURNO 4";
            $statementTurno = $db->prepare("SELECT id, cveelector, apepat, apemat, nombre, fechnac, domicilio, telefono, seccelec, municipio, estatvoto, turnvoto FROM public.padronzinjov WHERE turnvoto='1' or turnvoto='2' or turnvoto='3' or turnvoto='".$turno."' order by turnvoto,id asc");
            $statementTurno->execute();
            $resultsTurno = $statementTurno->fetchAll(PDO::FETCH_ASSOC);
            ...
            $hoja5->getColumnDimension('G')->setWidth(150,'pt');
            $hoja5->getColumnDimension('H')->setWidth(100,'pt');
            $hoja5->getColumnDimension('I')->setWidth(80,'pt');
            $hoja5->getColumnDimension('J')->setWidth(90,'pt');
            $hoja5->getColumnDimension('K')->setWidth(90,'pt');
            
            $hoja5->getStyle('A2')->getFont()->SetBold(true);
            $hoja5->getStyle('A2')->getFont()->SetSize(14);
            $hoja5->setCellValue('A2', "TURNO 4 - ZINACANTEPEC JOVENES");
            $hoja5->mergeCells('A2:K2')->getStyle('A2:K2')->getAlignment()->setHorizontal('center');

            $hoja5->setCellValue('A3',"");
            $hoja5->mergeCells('A3:K3')->getStyle('A3:K3')->getAlignment()->setHorizontal('center');

            $hoja5->getStyle('A5:K5')->getAlignment()->setHorizontal('center');
            ...
            $hoja5->setCellValue('G5','DOMICILIO');
            $hoja5->setCellValue('H5','TELEFONO');
            $hoja5->setCellValue('I5','SECCION');
            $hoja5->setCellValue('J5','MUNICIPIO');
            $hoja5->setCellValue('K5','TURNO DE VOTO');
            ...
            foreach ($resultsTurno as $row) {
                if ($row["turnvoto"] == '1') {
                    ...
                    $hoja5->setCellValue('G'. $numregExcel4,$row["domicilio"]);
                    $hoja5->setCellValue('H'. $numregExcel4,$row["telefono"]);
                    $hoja5->setCellValue('I'. $numregExcel4,$row["seccelec"]);
                    $hoja5->setCellValue('J'. $numregExcel4,$row["municipio"]);
                    $hoja5->setCellValue('K'. $numregExcel4,$row["turnvoto"]);

                    $celfdas= "A".$numregExcel4.":K".$numregExcel4."";
            ...
            $hoja6->setCellValue('A2', "ESTADISTICAS - ZINACANTEPEC JOVENES");
            ...
            $hoja6->setCellValue('A6','ZINACANTEPEC JOVENES');
