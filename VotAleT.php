            ...
            <section id="secInfoTol">
                <div id="divGeneraArchivo">
                    <div id="divRadsBtnsTurnos">
                        <div class="divsRadBtns"><input type="radio" id="RadBtnTurno1" class="RadBtnsOptions" name="RdBtnsTurns" value="T1" checked><label for="RadBtnTurno1">Tiempo 1</label></div>
                        <div class="divsRadBtns"><input type="radio" id="RadBtnTurno2" class="RadBtnsOptions" name="RdBtnsTurns" value="T2"><label for="RadBtnTurno2">Tiempo 2</label></div>
                        <div class="divsRadBtns"><input type="radio" id="RadBtnTurno3" class="RadBtnsOptions" name="RdBtnsTurns" value="T3"><label for="RadBtnTurno3">Tiempo 3</label></div>
                        <div class="divsRadBtns"><input type="radio" id="RadBtnTurno4" class="RadBtnsOptions" name="RdBtnsTurns" value="T4"><label for="RadBtnTurno4">Tiempo 4</label></div>
                    </div>
                    </div>
                    <div>
                ...
                <div id="ResultConsult">
                    <table id ="toluca_data" class="table display responsive nowrap">
                        <thead class="tab_toluca">
                            <tr>
...
<script type="text/javascript" src="asset/infotoluca.js"></script>
